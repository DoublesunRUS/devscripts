...
Сценарий: Отсутствует право "ИмяПрава" для справочника "ИмяСправочника"
	Дано я закрыл все окна клиентского приложения

	Если объект "Справочник.[ИмяСправочника]" недоступен по функциональным опциям
		Тогда я останавливаю выполнение сценария "Skipped"

	Если есть право "ИмяПрава" к объекту "Справочник.[ИмяСправочника]" тогда
		Тогда я вызываю исключение "Ошибочно установлено право [ИмяПрава] для справочника [ИмяСправочника]"
